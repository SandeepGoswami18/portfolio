...
// ✅ Updated Experience Data (as per your requirement)
const experiences = [
  {
    ...
    duration: "Internship",
    description:
      "Completed a Web Development internship at CodeAlpha where I worked on real projects, improved frontend skills, and built responsive UI using HTML, CSS, JavaScript and React.",
  },

  {
    ...
    duration: "6 Months",
    description:
      "Practiced Data Structures & Algorithms consistently for 6 months. Solved coding problems on platforms like LeetCode and improved logic building, time complexity understanding, and problem-solving approach.",
  },

  {
    ...
    duration: "Training",
    description:
      "Learned Web Development at WSBTech, covering HTML, CSS, JavaScript, React, and project-based learning. Built multiple mini projects and improved development workflow and design skills.",
  },
];
